...
const rotateVector = ([[a, b], [c, d]], [x, y]) => [
    a * x + b * y,
    c * x + d * y,
];
const createRotateMatrix = (x) => [
    [Math.cos(x), -Math.sin(x)],
    [Math.sin(x), Math.cos(x)],
];
const addVector = ([a1, a2], [b1, b2]) => [
    a1 + b1,
    a2 + b2,
];
const toRadian = (angle) => (angle / 180) * Math.PI;
const clamp = (value, min, max) => Math.min(Math.max(value, min), max);
const svgArc = (options) => {
    ...
    const [eX, eY] = addVector(rotateVector(rotMatrix, [
...
let ModernCircularGauge = class ModernCircularGauge extends h {
    setConfig(config) {
        if (!config.entity) {
            throw new Error("Entity must be specified");
        }
        this._config = Object.assign({ min: DEFAULT_MIN, max: DEFAULT_MAX }, config);
    }
    _strokeDashArc(from, to) {
    ...
    _valueToPercentage(value) {
        ...
        return (clamp(value, (_b = (_a = this._config) === null || _a === void 0 ? void 0 : _a.min) !== null && _b !== void 0 ? _b : DEFAULT_MIN, (_d = (_c = this._config) === null || _c === void 0 ? void 0 : _c.max) !== null && _d !== void 0 ? _d : DEFAULT_MAX) - ((_f = (_e = this._config) === null || _e === void 0 ? void 0 : _e.min) !== null && _f !== void 0 ? _f : DEFAULT_MIN))
            / (((_h = (_g = this._config) === null || _g === void 0 ? void 0 : _g.max) !== null && _h !== void 0 ? _h : DEFAULT_MAX) - ((_k = (_j = this._config) === null || _j === void 0 ? void 0 : _j.min) !== null && _k !== void 0 ? _k : DEFAULT_MIN));
    }
    render() {
        var _a, _b;
        ...
        const unit = (_a = this._config.unit) !== null && _a !== void 0 ? _a : stateObj.attributes.unit_of_measurement;
    ...
    <ha-card>
      ...
      <div class="bottom">
        <p class="name">
          ${(_b = this._config.name) !== null && _b !== void 0 ? _b : ""}
        </p>
      </div>
    </ha-card>
    `;
...
__decorate([
    n({ attribute: false })
], ModernCircularGauge.prototype, "hass", void 0);
__decorate([
    r()
], ModernCircularGauge.prototype, "_config", void 0);
ModernCircularGauge = __decorate([
    t("modern-circular-gauge")
], ModernCircularGauge);
